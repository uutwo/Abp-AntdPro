...
using TuDou.Grace.Web.Controllers;
using TuDou.Grace.Web.Models.Consent;

namespace TuDou.Grace.Web.Host.Controllers
{
    public class ConsentController : GraceControllerBase
    {
